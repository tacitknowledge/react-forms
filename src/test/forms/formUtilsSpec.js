...
import * as utils from '../../main/forms/formUtils';
import FormGroup from '../../main/forms/formGroup';
...
describe('Form Utilities', () => {
  ...
  describe('replaceNullForEmptyString', () => {
    let values;
    beforeEach(() => {
      values = {
        line1: 'Something 1',
    ...
    it('SHOULD return an object', () => {
      const filteredValues = utils.replaceNullForEmptyString(values);

      expect(filteredValues).toBeObject();
    });

    it('SHOULD return the value if not null', () => {
      const filteredValues = utils.replaceNullForEmptyString(values);

      expect(filteredValues.line1).toBe(values.line1);
    });

    it('SHOULD return null values as an empty string', () => {
      const filteredValues = utils.replaceNullForEmptyString(values);

      expect(filteredValues.line2).toBe('');
    });
  });
});
